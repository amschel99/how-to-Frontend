...
const Cart = () => {
  ...
  return (
    <div className='bg-sea-400   z-40 lg:h-[200px] xlg:h-[200px] sm:h-[260px] md:h-[260px] h-[260px] flex justify-evenly  fixed items-start w-screen  flex-wrap'
>
...
<h1 className='text-crimson-300 font-lato font-bold mx-4'>We customize everything!</h1>
<h3>Payments are done to PAYBILL <span className='font-bold text-pink-400 font-heading'>23456789</span></h3>
</div>
    </div>
  )
}
