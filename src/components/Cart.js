...
<div className="flex w-screen justify-center items-start lg:ml-20 xlg:ml-20 sm:ml-14 md:ml-14 ml-14  flex-wrap">
...
<h3> Paybill Number <span className='font-bold text-pink-400 font-heading'>23456789</span></h3>
</div>
    </div>
  )
}
